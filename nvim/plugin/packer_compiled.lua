...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/Users/mike/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["darkplus.nvim"] = {
    loaded = true,
    path = "/Users/mike/.local/share/nvim/site/pack/packer/start/darkplus.nvim",
  ...
  ["gitlinker.nvim"] = {
    loaded = true,
    path = "/Users/mike/.local/share/nvim/site/pack/packer/start/gitlinker.nvim",
  ...
  ["mini.surround"] = {
    loaded = true,
    path = "/Users/mike/.local/share/nvim/site/pack/packer/start/mini.surround",
